...
public class HallOfFameManager {
    ...
    public static volatile String content = I18n.format("msg.halloffame.fetching");
    ...
    private static final String HALL_OF_FAME_URL_KEY = "hall_of_fame.url";
    ...
    private static final String CACHE_FILE = "hall_of_fame.md";
    ...
    public static void forceRefresh() {
        ...
        new Thread(() -> {
            try {
                Document doc = HttpsCompat.connect(SharechainLinkConfig.getRequiredUrl(HALL_OF_FAME_URL_KEY))
                ...
                if (content == null || content.trim().isEmpty()
                        || content.equals(I18n.format("msg.halloffame.fetching"))) {
                    content = I18n.format("msg.halloffame.fetch_failed", e.getMessage());
                }
                zszlScriptMod.LOGGER.error("Failed to fetch Hall of Fame content", e);
            } finally {
                fetchInProgress = false;
            }
        }, "HallOfFame-Refresh").start();
    }
}
