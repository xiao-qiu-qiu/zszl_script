...
package com.zszl.zszlScriptMod.shadowbaritone.pathing.precompute;
...
import static com.zszl.zszlScriptMod.shadowbaritone.pathing.precompute.Ternary.MAYBE;
import static com.zszl.zszlScriptMod.shadowbaritone.pathing.precompute.Ternary.YES;
...
public class PrecomputedData {
    ...
    private int fillData(int id, IBlockState state) {
        ...
        data[id] = blockData; // in theory, this is thread "safe" because every thread should compute the
                              // exact same int to write?
        return blockData;
    }
