package com.zszl.zszlScriptMod.shadowbaritone.selection;
...
public class Selection implements ISelection {
     ...
     * <p>
     * Let's say you specify EnumFacing.UP, this functions returns if pos2 is the
     * highest BlockPos.
     ...
     *         {@code false} if it isn't, and something
     *         else if they're both at the same position on that axis (it really
     *         doesn't matter)
     */
