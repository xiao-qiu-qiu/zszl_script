 ...
 * selection is commonly used for certain
...
public interface ISelection {
    ...
    /**
     * @return The second corner of this selection. This is meant to preserve the
     *         user's original second corner.
     */
    BetterBlockPos pos2();

    /**
     * @return The {@link BetterBlockPos} with the lowest x, y, and z position in
     *         the selection.
     */
    BetterBlockPos min();
    ...
    /**
     * Returns a new {@link ISelection} expanded in the specified direction by the
    ...
    /**
     * Returns a new {@link ISelection} contracted in the specified direction by the
     * specified number of blocks.
     * <p>
    ...
    /**
     * Returns a new {@link ISelection} shifted in the specified direction by the
     * specified number of blocks. This moves
     * the whole selection.
     *
