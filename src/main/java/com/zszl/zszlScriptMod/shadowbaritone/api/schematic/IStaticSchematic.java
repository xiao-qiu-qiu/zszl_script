 ...
 * position without
 * additional context. Schematics of this type are expected to have non-varying
 * contents.
 *
 * @author Brady
...
public interface IStaticSchematic extends ISchematic {
    ...
    /**
     * Gets the {@link IBlockState} for a given position in this schematic. It
     * should be guaranteed
     * that the return value of this method will not change given that the
    ...
    /**
     * Returns an {@link IBlockState} array of size {@link #heightY()} which
     * contains all
     * desired block states in the specified vertical column. The index of
     * {@link IBlockState}s
