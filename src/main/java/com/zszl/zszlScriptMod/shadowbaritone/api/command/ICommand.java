...
public interface ICommand extends Helper {
    ...
    /**
     * Called when the command needs to tab complete. Return a Stream representing
     * the entries to put in the completions
     * list.
     */
    Stream<String> tabComplete(String label, IArgConsumer args) throws CommandException;

    /**
     * @return A <b>single-line</b> string containing a short description of this
     *         command's purpose.
     */
    String getShortDesc();
    ...
    /**
     * @return A list of the names that can be accepted to have arguments passed to
     *         this command
     */
