...
package com.zszl.zszlScriptMod.shadowbaritone.api.command.argparser;
...
public interface IArgParser<T> {
    ...
    /**
     * A stateless argument parser is just that. It takes a {@link ICommandArgument}
     * and outputs its type.
     */
    interface Stateless<T> extends IArgParser<T> {
         ...
         * @throws RuntimeException if you want the parsing to fail. The exception will
         *                          be caught and turned into an
         *                          appropriate error.
         */
     ...
     * {@link ICommandArgument}, but it also
