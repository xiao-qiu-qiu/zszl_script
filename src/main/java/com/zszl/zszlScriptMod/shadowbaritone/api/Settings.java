...
import com.zszl.zszlScriptMod.shadowbaritone.api.utils.NotificationHelper;
import com.zszl.zszlScriptMod.shadowbaritone.api.utils.SettingsUtil;
import com.zszl.zszlScriptMod.shadowbaritone.api.utils.TypeUtils;
import com.zszl.zszlScriptMod.shadowbaritone.api.utils.gui.BaritoneToast;
...
public final class Settings {
    ...
    /**
     * Blocks that Baritone should treat as hard pathing blockers.
     */
    public final Setting<List<Block>> blockingBlocks = new Setting<>(new ArrayList<>(Arrays.asList(
            Blocks.TRIPWIRE,
            Blocks.COCOA,
            Blocks.SKULL,
            Blocks.END_ROD,
    ...
    /**
     * Blocks that Baritone may traverse by interacting with them first.
     */
    public final Setting<List<Block>> interactionBlocks = new Setting<>(new ArrayList<>(Arrays.asList(
            Blocks.OAK_DOOR,
            Blocks.SPRUCE_DOOR,
            Blocks.BIRCH_DOOR,
            Blocks.JUNGLE_DOOR,
    ...
    /**
     * Blocks that Baritone should treat as dangerous when evaluating movement
     * hazards.
     */
    public final Setting<List<Block>> dangerousBlocks = new Setting<>(new ArrayList<>(Arrays.asList(
    ...
    /**
     * Enables the dedicated parkour planner and executor.
     */
    public final Setting<Boolean> parkourMode = new Setting<>(false);
    ...
    /**
     * Renders additional parkour planning and execution debug state.
     */
    public final Setting<Boolean> parkourDebugRender = new Setting<>(false);
    ...
    /**
     * Render detected edge portals around the player for narrow-gap debugging
     */
    public final Setting<Boolean> renderDetectedEdgePortals = new Setting<>(false);
    ...
    /**
     * Whether zszl_script navigation requests should directly call the built-in
     * shadowbaritone processes instead of routing through command-style invocation.
     * <p>
     * This setting only affects how the mod issues navigation requests. It does not
     * change the Baritone command prefix itself.
     */
    public final Setting<Boolean> useBuiltinBaritone = new Setting<>(false);
     ...
     */
    public final Setting<Integer> maxYLevelWhileMining = new Setting<>(255); // 1.17+ defaults to maximum possible world
                                                                             // height
    ...
    public final Setting<Consumer<ITextComponent>> logger = new Setting<>(
            msg -> Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(msg));
     ...
     */
    @JavaOnly
    public final Setting<BiConsumer<ITextComponent, ITextComponent>> toaster = new Setting<>(
    ...
    /**
     * The color of detected edge portals
     */
    public final Setting<Color> colorDetectedEdgePortals = new Setting<>(Color.ORANGE);
