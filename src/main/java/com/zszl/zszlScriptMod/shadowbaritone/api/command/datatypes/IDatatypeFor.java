 ...
 * difference
 * is that it requires an {@link IDatatypeContext} to be provided due to the
 * expectation that
...
public interface IDatatypeFor<T> extends IDatatype {
     ...
     * {@link IDatatypeContext}, and
     * then returns the parsed value. This method will more than likely return a
     * {@link IllegalArgumentException}
     * if the expected input does not conform to a parseable value. As far as a
     * {@link CommandException} being
     * thrown is concerned, see the note below for specifics.
     *
     * @param ctx The context
     * @return The parsed data-type
     * @throws CommandException If there was an issue parsing using another type or
     *                          arguments could not be polled.
