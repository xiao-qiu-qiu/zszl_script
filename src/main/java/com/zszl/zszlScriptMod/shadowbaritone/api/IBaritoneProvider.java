...
public interface IBaritoneProvider {
    ...
    /**
     * Returns the primary {@link IBaritone} instance. This instance is persistent,
     * and
     * is represented by the local player that is created by the game itself, not a
     * "bot"
    ...
    /**
     * Provides the {@link IBaritone} instance for the player with the specified
     * connection.
     *
    ...
    /**
     * Creates and registers a new {@link IBaritone} instance using the specified
     * {@link Minecraft}. The existing
    ...
    /**
     * Destroys and removes the specified {@link IBaritone} instance. If the
     * specified instance is the
     * {@link #getPrimaryBaritone() primary baritone}, this operation has no effect
     ...
     * {@link IBaritone} implementation, because it is not linked with
     * {@link IBaritone}.
     *
    ...
    /**
     * Returns the {@link ICommandSystem} instance. This is not bound to a specific
     * {@link IBaritone}
     * instance because {@link ICommandSystem} itself controls global behavior for
     * {@link ICommand}s.
     *
