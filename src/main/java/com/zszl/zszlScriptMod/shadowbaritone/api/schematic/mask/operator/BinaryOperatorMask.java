...
package com.zszl.zszlScriptMod.shadowbaritone.api.schematic.mask.operator;
...
import com.zszl.zszlScriptMod.shadowbaritone.api.utils.BooleanBinaryOperator;
...
public final class BinaryOperatorMask extends AbstractMask {
    ...
    public static final class Static extends AbstractMask implements StaticMask {
        ...
        public Static(StaticMask a, StaticMask b, BooleanBinaryOperator operator) {
            super(Math.max(a.widthX(), b.widthX()), Math.max(a.heightY(), b.heightY()),
